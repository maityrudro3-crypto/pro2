...
const name = "𓆩⎯⃪꯭̽𝐑᪵͢𝐮᪳ᷱ𝚍֟ؖ۬𝐫σ𝆭•𝚵꯭̽ 𝐱 𝐦𝐝𓆪᪴";
const runtime = (secs) => {
...
*┃🌨️ ᴛɪᴍᴇ    :* ${time}
*┃🫂 ᴜsᴇʀ    :* ${userName}
*┃🕊️ ᴘᴀɪʀ   :* http://t.me/W4tubdt_bot
*┃🎀 owner   : 𓆩⎯⃪꯭̽𝐑᪵͢𝐮᪳ᷱ𝚍֟ؖ۬𝐫σ𝆭•𝚵꯭̽𓆪᪴*
*┃🎐 devloper : 𓆩⎯⃪꯭̽𝐑᪵͢𝐮᪳ᷱ𝚍֟ؖ۬𝐫σ𝆭•𝚵꯭̽𓆪᪴*
*╰═════════════════⊷*
${readMore}
*♡︎•━━━━━Rudro x md━━━━━━•♡*
`;
      ...
      _cmd_st += `*~_Made with love by Rudro x md_~*`;
    }

    const channelJid = "120363411218386827@newsletter";
    const channelName = "© Rudro x md";
