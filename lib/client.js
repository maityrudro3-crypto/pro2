...
function makeGiftQuote(pushname) {
  return {
    key: {
      fromMe: false,
      participant: "919382951134@s.whatsapp.net",
    ...
    message: {
      contactMessage: {
        ...
        vcard: [
          ...
          `N:;${pushname || "User"};;`,
          `FN:${pushname || "User"}`,
          "item1.TEL;waid=919382951134:919382951134",
...
async function onConnected(sessionId) {
  try {
            ...
            botjid,
            {
              ...
              contextInfo: {
                ...
                externalAdReply: {
                  ...
                  body: "",
                  thumbnailUrl: "https://mhcloud.kesug.com/images/new.png",
                  sourceUrl:
                    "https://https://whatsapp.com/channel/0029VbDXVv37DAX7AcCwFw1N",
                  mediaType: 1,
                  renderLargerThumbnail: true,
                },
              },
            },
            { quoted: makeGiftQuote("𓆩⎯⃪꯭̽𝐑᪵͢𝐮᪳ᷱ𝚍֟ؖ۬𝐫σ𝆭•𝚵꯭̽𓆪᪴") }
          );
        } catch (e) {
      ...
      setImmediate(async () => {
        try {
          ...
          const start_msg = [
            ...
            `*╭━━━〔📞 𝗖𝗢𝗡𝗧𝗔𝗖𝗧〕━━━✦*`,
            `*┃👑 𝐃𝐄𝐕𝐄𝐋𝐎𝐏𝐄𝐑 :* +919382951134`,
            `*┃🌚 𝐒𝐔𝐏𝐏𝐎𝐑𝐓    :* https://whatsapp.com/channel/0029VbDXVv37DAX7AcCwFw1N`,
            `*╰━━━━━━━━━━━━━━━━━╯*`,
          ].join("\n");
          ...
          await sock.sendMessage(
            botjid,
            {
              ...
              contextInfo: {
                mentionedJid: [botjid],
                externalAdReply: {
                  title: "𝐓𝐇𝐀𝐍𝐊𝐒 𝐅𝐎𝐑 𓆩⎯⃪꯭̽𝐑᪵͢𝐮᪳ᷱ𝚍֟ؖ۬𝐫σ𝆭•𝚵꯭̽ 𝐱 𝐦𝐝𓆪᪴ 𝐂𝐇𝐎𝐎𝐒𝐈𝐍𝐆",
                  body: "",
                  thumbnailUrl: "https://mhcloud.kesug.com/images/new.png",
                  sourceUrl:
                    "https://whatsapp.com/channel/0029VbDXVv37DAX7AcCwFw1N",
                  mediaType: 1,
                  renderLargerThumbnail: true,
                },
              },
    ...
    await sock
      .newsletterFollow("120363411218386827@newsletter")
      .catch(() => {});
    await sock
      .newsletterFollow("120363411218386827@newsletter")
      .catch(() => {});
